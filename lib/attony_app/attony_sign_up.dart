...
class SignUpAttorney extends StatefulWidget {
  final Function toggle;
  SignUpAttorney(this.toggle);

  @override
  _SignUpAttorneyState createState() => _SignUpAttorneyState();
}

class _SignUpAttorneyState extends State<SignUpAttorney> {
  ...
  signMeUp(){
    if(formKey.currentState.validate()){
      Map<String ,String> attorneyInfoMap= {
      ...
      authMethods.signUpWithEmailAndPassword(emailTextEditingController.text,
        ...
        databaseMethods.uploadAttorneyInfo(attorneyInfoMap);
        Navigator.pushReplacement(context, MaterialPageRoute(
            builder: (context) => AttorneyDashBoard()
        ));
      });
    }
  }
